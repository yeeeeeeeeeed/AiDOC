...
from routers import upload, extract_content, extract_table, summary, compare, translate, export, history, me, limits
...
app.include_router(limits.router,          prefix="/api/admin")
